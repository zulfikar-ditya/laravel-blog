...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade" id="pills-deactive" role="tabpanel" aria-labelledby="pills-profile-tab">
        <div class="container bg-white shadow mb-5 p-5 text-center"  style="margin-top: 70px">
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 style="letter-spacing: 10px">Hide Post</h2>
                    <hr class="border-info">
                    <a href="{{route('admin-blog-hide', ['id' => $data[0]['id']])}}" class="btn btn-outline-danger">Hide</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container bg-white shadow mb-5 p-5 text-center" style="margin-top: 70px">
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    ...
                    <hr class="border-info">
                    <a href="{{route('admin-blog-unhide', ['id' => $data[0]['id']])}}" class="btn btn-outline-success">Un Hide</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container bg-white shadow mb-5 p-5 text-center" style="margin-top: 70px">
                <div class="row justify-content-center">
                    <div class="col-md-7 text-center">
                        ...
                        <hr class="border-info">
                        <a href="{{route('admin-blog-delete', ['id' => $data[0]['id']])}}" class="btn btn-outline-danger">Delete</a>
                    </div>
                </div>
            </div>
        </div>
